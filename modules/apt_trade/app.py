...
# modules/apt_trade/app.py 기준 프로젝트 루트(2단계 위). "modules" 패키지를
# 절대 import(from modules.apt_trade import core)로 찾으려면 루트가 sys.path에 있어야 한다.
_PROJECT_ROOT = pathlib.Path(__file__).resolve().parents[2]
if str(_PROJECT_ROOT) not in sys.path:
    sys.path.insert(0, str(_PROJECT_ROOT))

from modules.apt_trade import core
